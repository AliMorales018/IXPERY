...
public class GeneralHTMLOPC {
    public String ConvertDataToHtmlOpc(List<String[]> datos, List<String[]> tipoDatoId, List<List<String[]>> dsSelect, String Tabla,String opcion) {
        String html = "";
        int cont;
        String tag;
        String id;
        ...
        for (int i = 0; i < filas; i++)
        {
            ...
            nSelect = 0;
            cont = i + 1;
            html += "<tr class='selected' id='fila"+ Tabla + cont + "' onclick='llenarRegistro" + Tabla + "(this.id," + cont + ")'>";
            ...
            for (int j = 1; j < columnas; j++)
            {
                ...
                switch(tag){
                    case "input":
                        html += RetornaInputHtml(id, valor, tipo, cont,estilo);
                        break;
            ...
            if(opcion=="preempresa" || opcion=="producto" || opcion=="proveedor")
            {
                html += "<td>";
                html += "<div>";
                html += "<button type='button' class='btn btn-sm-search' id='btnVer" + Tabla + "" + cont + "' runat='server'>";
    ...
    public String RetornaInputHtml(String Id, String Valor, String Tipo, int cont, String estilo) {
        String attr = "";
        ...
        String input = "";
        input += "<td " + attr + " "+estilo+">";
        input += "<div>";
        input += "<input type='" + Tipo + "' id='" + Id + cont + "' name='" + Id + cont + "' readonly='readonly' style='border:none; background-color: #f2f2f2; color: black' class='form-control' value='" + Valor + "'/>";
        input += "</div>";
        input += "</td>";
