            ...
            <div class="cell large-8">
                <div class="grid-x align-center align-top">
                    <div class="cell text-center" style="visibility:visible">
                        <div style="margin-bottom: 5px"><span class="spn-equipo-emp text-primary" style="font-size:14px;font-weight:bold"></span></div>
                        <div style="margin-bottom: 5px"><span class="spn-equipo-pro text-primary" style="font-size:14px;font-weight:bold"></span></div>
                        <div><span class="spn-equipo-req text-primary" style="font-size:12px;font-weight:bold"></span></div>
                    </div>
                </div>
            </div>
