...
public class CEquipo3 {
    ...
    public ModelAndView Equipo(){
        ...
        ModelAndView modelView = new ModelAndView("logistica/equipo3");
        modelView.addObject("fecha",dateParse);
        return modelView;
    }

    @RequestMapping(value="/equipo3/register", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value = "/equipo3/busprovprod", produces = "application/json")
    ...
    @RequestMapping(value="/equipo3/buscarequiposol", method=RequestMethod.POST)
