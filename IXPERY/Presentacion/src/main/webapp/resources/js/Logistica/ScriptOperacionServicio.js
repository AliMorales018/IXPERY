            ...
            if (JsonObjectItems2.items.length > 1) {
                ...
                $.each(JsonObjectItems2.items[2].PERSONALTRANSITO, function (index, item) {
                    elementsPT += "<tr>" +
                        ...
                        "<td><p class='form-control'><b>S/ "+item.salarioxdia+"</b></p></td>"+
                        "<td><p class='form-control'><b>S/ "+item.subtotal+"</b></p></td>"+
                        "<td><p class='form-control'><b>S/ "+item.total+"</b></p></td>"+
                        "</tr>";
                ...
                $.each(JsonObjectItems2.items[1].ACTIVIDAD, function (index, item) {
                    cont_actividades_tabla++;
                    $("#container_actividades").append("<div id='actividad_"+cont_actividades_tabla+"' class='actividad>"+
                        "<div class='grid-x grid-padding-x' style='margin-bottom:10px'>"+
                    ...
                    $.each(item.cargoslaborales, function (index, item) {
                        $("#actividad_"+cont_actividades_tabla+" table tbody").append("<tr id='actividad_"+cont_actividades_tabla+"_fila_"+countCL+"'>" +
                            ...
                            "<td class='text-center'><span class='form-control'>"+item.diaspago+"</span></td>"+
                            "<td><span class='form-control'><b>S/ "+item.salarioxdia+"</b></span></td>"+
                            "<td><span class='form-control'><b>S/ "+item.subtotallaboral+"</b></span></td>"+
                            "<td><span class='form-control'><b>S/ "+item.totallaboral+"</b></span></td>"+
                            "<td title='Actualizar salario' class='text-center'><button class='btn-icon-salario'>S/.</button></td>"+
